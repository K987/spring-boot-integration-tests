...
public abstract class BeforeAndAfterAllTest extends AbstractUserRepositoryTest {
    ...
    void insertJaneDoe() {
        ...
        /*
            ...
            The @BeforeAll method itself is not transactional,
            so we need to create a transaction here.
        */
        executeInNewTransaction(() -> createAndPersist(JANE_DOE));
    }
    ...
    void deleteJaneDoe() {
        ...
        /*
            TestEntityManager operations must run inside a transaction.
            The @AfterAll method itself is not transactional,
            so we need to create a transaction here.
        */
        executeInNewTransaction(() -> delete(JANE_DOE));
    }
}
